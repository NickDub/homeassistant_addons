...
class VersionScreen(BaseScreen):
    def render(self):
        ...
        # Draw Icons
        self.display.draw.text((TITLE_BASE, LINE_1), ICON_HOME, font=self.font(16, is_bold=False, is_icon=True), fill=255)
        # Draw Text
        self.display.draw.text((TITLE_TEXT_WITH_ICON, LINE_1), "VERSIONS", font=self.font(16), fill=255)
        self.display.draw.text((LINE_BASE, LINE_2), "OS: " + os_version, font=self.font(16), fill=255)
        self.display.draw.text((LINE_BASE, LINE_3), "Core: " + core_version, font=self.font(16), fill=255)
...
class CpuScreen(BaseScreen):
    ...
    def render(self):
        ...
        self.display.draw.text((LINE_BASE, LINE_2), ICON_TACHOMETER, font=self.font(16, is_bold=False, is_icon=True), fill=255)
        self.display.draw.text((LINE_BASE, LINE_3), ICON_THERMOMETER, font=self.font(16, is_bold=False, is_icon=True), fill=255)
        self.display.draw.text((LINE_BASE, LINE_4), ICON_HOURGLASS, font=self.font(16, is_bold=False, is_icon=True), fill=255)
        # Draw Text
        self.display.draw.text((TITLE_TEXT_WITH_ICON, LINE_1), "CPU", font=self.font(16), fill=255)
        self.display.draw.text((LINE_TEXT_WITH_ICON, LINE_2), str(cpu) + "LA", font=self.font(16), fill=255)
        self.display.draw.text((LINE_TEXT_WITH_ICON, LINE_3), temp, font=self.font(16), fill=255)
        self.display.draw.text((LINE_TEXT_WITH_ICON, LINE_4), str(uptime), font=self.font(16), fill=255)
